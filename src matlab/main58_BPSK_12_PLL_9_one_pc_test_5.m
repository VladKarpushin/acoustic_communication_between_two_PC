...
nSignBarker = 16;   %quantity of Barker codes in a set.
...
PLL_offset_vs_BER = [PLL_offset_n' MaxAbsSignAmp MaxSignSync MinSignSync MaxSignSync-MinSignSync BER delta nInfBits*Samples - delta StdSignSync];
m = -2;
i = -2;
