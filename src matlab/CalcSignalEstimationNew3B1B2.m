...
function [EstSignal_b MaxSignSyncB1 MinSignSyncB1 Err delta StdSignSync SignalContell] = CalcSignalEstimationNew3B1B2(CorrIntegral,threshold, SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period,SignalComplex)
% input:
