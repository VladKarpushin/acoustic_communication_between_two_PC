...
for i = 1:n
    ...
    i
    [EstSignal_b MaxSignSync(i) MinSignSync(i) Err delta(i) StdSignSync(i)] = CalcSignalEstimationNew2B1B2(CorrIntegral,threshold, SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period); %This function estimates information bits (information signal)
...
ErrSyst = (n*length(SignBarkerB2) + nInfBits)*Samples - delta; %systematic error between nInfBits*Samples and delta
...
[CorrIntegral] = CalcCoherentReceptionNew2(z,Samples,F,Fs,PLL_offset_n(i));   %coherent reception
[EstSignal_b] = CalcSignalEstimationNew2B1B2(CorrIntegral,threshold, SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period); %This function estimates information bits (information signal)
x = 1:length(z);
%x=x/Fs;
