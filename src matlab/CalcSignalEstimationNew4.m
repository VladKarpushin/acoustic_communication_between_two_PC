...
function [est_signal_b  MaxSignSync MinSignSync Err delta StdSignSync signal_constel iA iB] = CalcSignalEstimationNew4(threshold, sign_barker_long, samples, signal_complex)
% input:
