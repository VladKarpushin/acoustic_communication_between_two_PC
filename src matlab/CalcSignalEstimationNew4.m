...
function [EstSignal_b  MaxSignSync MinSignSync Err delta StdSignSync SignalContell iA iB] = CalcSignalEstimationNew4(CorrIntegral, threshold, SignBarkerLong, Samples, SignalComplex)
% input:
