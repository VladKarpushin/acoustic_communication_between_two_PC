...
kt = 15;     %coefficient of duration of one symbol, kt/F = duration of one symbol
...
SNR = 10e17;        %signal to noise ratio
...
SignalLong = SignalLongFilter(SignalLong, Samples, Fs);
...
[EstSignal_b MaxSignSync MinSignSync Err delta StdSignSync SignalContell] = CalcSignalEstimationNew3(CorrIntegral,threshold, SignBarkerLong, Samples, SignalComplex); %This function estimates information bits (information signal)
x = 1:length(z);
%x=x/Fs;
