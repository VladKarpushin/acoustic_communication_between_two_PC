...
nInfBits = 1024*8*1+256;   %number of information bits
...
[EstSignal_b a b c d e SignalContell] = CalcSignalEstimationNew4B1B2(CorrIntegral,threshold(i), SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period,SignalComplex,z); %This function estimates information bits (information signal)
