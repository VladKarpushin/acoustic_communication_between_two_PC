...
%2016-11-27 added added code for signal constellation
...
nInfBits = 1024*8*3 + 256;   %number of information bits
...
for i = 1:n
    ...
    [EstSignal_b MaxSignSync(i) MinSignSync(i) Err] = CalcSignalEstimationNew3B1B2(CorrIntegral,threshold(i), SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period,SignalComplex); %This function estimates information bits (information signal)
...
[EstSignal_b] = CalcSignalEstimationNew3B1B2(CorrIntegral,threshold(i), SignBarkerB1Long,SignBarkerB2Long, Samples,nInfBits,period,SignalComplex); %This function estimates information bits (information signal)
