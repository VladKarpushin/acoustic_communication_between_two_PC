...
function [est_signal_b, max_sync_b1, max_sync_b2, err, signal_constel, ind_a, ind_b] = calc_signal_estimation_bpsk(threshold, sign_barker_b1_long, sign_barker_b2_long, samples, signal_complex, m_type)
% input:
...
if sign(sync_b1(ind_max_sync_b1)) < 0
    ...
    est_signal_long_q = -est_signal_long_q;
end
