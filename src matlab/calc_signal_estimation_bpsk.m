...
function [est_signal_b,  max_sync_b1, max_sync_b2, Err, delta, signal_constel, iA, iB] = calc_signal_estimation_bpsk(threshold, sign_barker_b1_long, sign_barker_b2_long, samples, signal_complex)
% input:
