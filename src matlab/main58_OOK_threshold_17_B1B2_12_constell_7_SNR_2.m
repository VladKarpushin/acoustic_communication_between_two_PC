...
s = std(z(indexA-length(SignBarkerB1Long):indexB+length(SignBarkerB1Long)));
n = std(z(1:indexA-length(SignBarkerB1Long)-4));
SNR_estimated = s/n;
disp(['SNR estimated = ',num2str(SNR_estimated)]);
disp(['SNR estimated = ',num2str(10*log10(SNR_estimated)), ' [dB]']);
